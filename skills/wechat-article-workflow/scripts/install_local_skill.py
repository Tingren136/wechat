...
def install_local_skill(target_root: Path | None = None) -> Path:
    ...
    lizi_illustrator_skill_dir = repo_root / "skills" / "lizi-article-illustrator"
    ...
    if lizi_illustrator_skill_dir.exists():
        copy_tree(lizi_illustrator_skill_dir, target_root / lizi_illustrator_skill_dir.name)
